...
class ServiceController {
    static getAll(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { category, minPrice, maxPrice, status, deliveryTime } = req.query;
                const filters = {};
                if (category)
                ...
                const services = yield serviceService_1.default.getAll(filters);
    ...
    static search(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const services = yield serviceService_1.default.search(criteria);
                return res.status(200).json(services);
            }
            catch (error) {
